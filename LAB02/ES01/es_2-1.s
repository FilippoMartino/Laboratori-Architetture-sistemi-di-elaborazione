...
LOOP:
	...
	mul.d	F10, F4, F1		; F10 = v4[i] * v1[i]
	div.d	F6, F5, F10		; F6 = v5[i]/(v4[i] * v1[i])
	s.d		F6, v6(R11)		; load into v6[i]
	
	add.d	F10, F2, F3		; F10 = v2[i] + v3[i]
	mul.d	F10, F6, F10	; F10 = v6[i]* (v2[i] + v3[i])
	s.d		F10, v7(R11)	; load into v7[i]
